...
Ctrl+P opens the command palette; Ctrl+O opens saved sessions; both preserve the composer draft. Ctrl+D opens the revision-labelled diff and Ctrl+R shows declared Rails evidence.
