...
export class LiveInspection {
 ...
 async stop(cancelled=false):Promise<{report:Report;reportPath:string}>{
  ...
  }finally{await this.service.stop(false);this.lease.close();}
 }
}
