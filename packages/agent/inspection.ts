...
export async function runInspection(options:{root:string;flow:Flow;lease?:WorktreeLease;store:SessionStore;signal:AbortSignal;onEvent?:(event:Envelope)=>void}){
