...
export class TuiController {
 private argumentCommand:TerminalCommand|undefined;private repairAttempts:0|1=1;model:ScreenModel;verifiers:Verifier[]=[];
 ...
 async command(text:string){await this.submit(text,true);}
