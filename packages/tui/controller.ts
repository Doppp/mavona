...
export class TuiController {
 private sessions:ReturnType<typeof listSessions>=[];private argumentCommand:TerminalCommand|undefined;private repairAttempts:0|1=1;model:ScreenModel;verifiers:Verifier[]=[];
